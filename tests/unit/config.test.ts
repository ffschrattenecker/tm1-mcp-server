...
describe("loadConfig", () => {
  ...
  it("should throw when TM1_BASE_URL is missing", () => {
    ...
    expect(() => loadConfig()).toThrow(
      "Missing or empty required environment variables: TM1_BASE_URL",
    );
  });
  ...
  it("should throw when TM1_USER is missing", () => {
    ...
    expect(() => loadConfig()).toThrow(
      "Missing or empty required environment variables: TM1_USER",
    );
  });
  ...
  it("should throw when TM1_PASSWORD is missing", () => {
    ...
    expect(() => loadConfig()).toThrow(
      "Missing or empty required environment variables: TM1_PASSWORD",
    );
  });
