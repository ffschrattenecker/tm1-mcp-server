...
import { ProcessCodeBundleSchema } from "../schemas/items.js";
...
export const registerGetAllProcessesCode = defineTool({
  name: "tm1_get_all_processes_code",
  description:
  ...
  handler: async (
    { includeControl, limit, maskSecrets, summary },
    tm1Client,
  ) => {
