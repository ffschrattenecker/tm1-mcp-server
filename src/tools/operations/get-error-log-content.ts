...
import { ErrorLogContentResultSchema } from "../schemas/items.js";
...
export const registerGetErrorLogContent = defineTool({
  name: "tm1_get_error_log_content",
  description: [
  ...
  output: ErrorLogContentResultSchema,
  input: {
    filename: z
      .string()
      .describe(
